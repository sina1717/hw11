...
public class AveragePrice {
    public static void main(String[] args) {
        ...
        Order order2 = new Order(2,customer2,p1, Date.valueOf("2022-1-15"));
        Order order3 = new Order(3,customer2,p2, Date.valueOf("2022-1-15"));
        Order order4 = new Order(4,customer1,p3, Date.valueOf("2022-1-20"));
        Order order5 = new Order(5,customer3,p5, Date.valueOf("2022-4-20"));
        Order order6 = new Order(6,customer2,p2, Date.valueOf("2022-1-15"));
        Order order7 = new Order(7,customer3,p1, Date.valueOf("2022-1-15"));
        Order order8 = new Order(8,customer3,p4, Date.valueOf("2022-2-29"));
        Order order9 = new Order(9,customer1,p2, Date.valueOf("2022-3-10"));
        ...
        double average = orderList
                .stream()
                .filter(o -> o.getDate().equals(Date.valueOf("2022-1-15")))
                .collect(Collectors.toList())
                .stream()
                .mapToInt(o->o.getProduct().getPrice())
                .average()
                .orElse(0.0);
